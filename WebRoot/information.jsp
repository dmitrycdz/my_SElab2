...
<div align="center"><a href=Search?username=<%out.print(list0.get(1)); %>><button type="button">返回</button></a></div>
<div align="center"><a href=Login><button type="button">返回主页</button></a></div>
</body>
</html>